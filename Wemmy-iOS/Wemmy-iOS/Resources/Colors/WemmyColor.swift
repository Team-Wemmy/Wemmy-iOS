...
extension Color {
    ...
    // Lightblue
    static let Lightblue100 = Color("Lightblue100")
    static let Lightblue200 = Color("Lightblue200")
    static let Lightblue300 = Color("Lightblue300")
    static let Lightblue400 = Color("Lightblue400")
    static let Lightblue500 = Color("Lightblue500")
